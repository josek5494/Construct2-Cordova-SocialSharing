...
{	
	...
	Acts.prototype.whatsappShare = function (msg, link, file)
	{
		if (typeof window['plugins'] == 'undefined') {return;}else{
		window['plugins']['socialsharing'].shareViaWhatsApp(msg,file,link);}
	}

	Acts.prototype.mailShare = function (msg, sub, rec, link, file)
	{
		if (typeof window['plugins'] == 'undefined') {return;}else{
		window['plugins']['socialsharing'].shareViaEmail(msg,sub,rec,'null','null',file,link);}
	}
