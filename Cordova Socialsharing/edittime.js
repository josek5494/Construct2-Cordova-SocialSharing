...
AddStringParam("Link", "");
AddStringParam("Image/File", "");
AddAction(2, af_none, "WhatsApp share", "Share Directly", "WhatsApp share", 
	"Skip the dialog and share directly to WhatsApp", "whatsappShare");

AddStringParam("Message", "");
AddStringParam("Subject", "");
AddStringParam("Receiver", "");
AddStringParam("Link", "");
AddStringParam("Image/File", "");
AddAction(2, af_none, "Mail share", "Share Directly", "Mail share", 
	"Skip the dialog and share directly by mail", "mailShare");
